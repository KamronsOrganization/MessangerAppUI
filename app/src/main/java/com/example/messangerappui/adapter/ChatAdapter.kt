package com.example.messangerappui.adapter
...
import com.example.messangerappui.R
...
class ChatAdapter(var context: Context, var items: ArrayList<Chat>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class RoomViewHolder(view: View, context: Context ): RecyclerView.ViewHolder(view) {
